About rt-eqcorrscan-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rt-eqcorrscan-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10280&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rt-eqcorrscan-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rt-eqcorrscan` can be installed with `conda`:
...
```
mamba install rt-eqcorrscan
```

It is possible to list all of the versions of `rt-eqcorrscan` available on your platform with `conda`:
...
```
mamba search rt-eqcorrscan --channel conda-forge
```
...
mamba repoquery search rt-eqcorrscan --channel conda-forge

# List packages depending on `rt-eqcorrscan`:
mamba repoquery whoneeds rt-eqcorrscan --channel conda-forge

# List dependencies of `rt-eqcorrscan`:
mamba repoquery depends rt-eqcorrscan --channel conda-forge
```
